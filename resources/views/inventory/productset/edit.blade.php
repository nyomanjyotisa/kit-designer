...
@php $Productset = ($Productset[0])?$Productset[0]:"";@endphp
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Edit Product Set</h5>
                            <span>Edit new product set in inventory</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-body">
                        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ route('update-product_set') }}">
                            @csrf                            
                            <div class="row">
                                <input type="hidden" name="productset_id" value="{{$Productset->productset_id}}" id="productset_id">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="title">Product set<span class="text-red">*</span></label>
                                        <input id="product_set" type="text" class="form-control w-40 hm-30" name="product_set" value="{{$Productset->product_set}}" placeholder="Enter product product name" required="">
                                        <div class="help-block with-errors"></div> 
                                    </div> 


                                    @if(!$Productset->productset_id)  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w-40 hm-30" name="parent_product_set" id="parent_product_set"  required="">
                                            ...
                                            {{$dropdown->getParentChild_edit()}}
                                        </select>  
                                        <div class="help-block with-errors"></div> 
                                    </div>
                                    @else
                                    <div class="form-group"> <input type="hidden" name="parent_product_set" @if($Productset->productset_id==1) value="0" @else value="{{$Productset->parent_productset_id}}" @endif> </div>
                                    @endif 
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <label for="title">Parent Product set<span class="text-red">*</span></label>
                                        <select class="form-control w-40 hm-30" name="parent_product_set" id="parent_product_set"  required="">
                                            {{$dropdown->getParentChild_edit($Productset->parent_productset_id)}}  
                                        </select> 
                                        <div class="help-block with-errors"></div> 
                                    </div>  -->
                                </div>
                                <div class="col-sm-12">
                                        ...
                                        <div class="form-inline">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$Productset->price_aud}}"  class="form-control w-60 text-center hm-30" name="price_aud">
                                                <label>&nbsp; AUD <span class="">&nbsp;</span</label> 
                                            </div> 
                                            <div class="form-group">
                                                <label for="title">€ &nbsp;</label> 
                                                <input type="text" value="{{$Productset->price_eur}}"   class="form-control w-60 text-center hm-30" name="price_eur">
                                                <label for="title">&nbsp; EUR<span class="">&nbsp;</span></label> 
                                            </div>
                                            <div class="form-group">
                                                <label for="title">£ &nbsp;</label> 
                                                <input type="text" value="{{$Productset->price_gbp}}"   class="form-control w-60 text-center hm-30" name="price_gbp">
                                                <label for="title">&nbsp; GBP<span class="">&nbsp;</span></label> 
                                            </div>
                                            <div class="form-group">
                                                <label for="title">$ &nbsp;</label> 
                                                <input type="text" value="{{$Productset->price_usd}}"    class="form-control w-60 text-center hm-30" name="price_usd">
                                                <label for="title">&nbsp; USD<span class="">&nbsp;</span></label> 
                                            </div> 
                                            <div class="form-group">
                                                <label for="title">$ &nbsp;</label> 
                                                <input type="text" value="{{$Productset->price_nzd}}"   class="form-control w-60 text-center hm-30" name="price_nzd">
                                  ...
                                  <br>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$Productset->minimum}}" class="form-control w-40 text-center hm-30"  name="minimum">
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Discount Levels&nbsp;</label>   
                                            <input type="text" value="{{$Productset->discountLevel}}" class="form-control w-300 text-center hm-30" name="discountLevel">
                                        </div>
                                        <div class="form-group">
                                        <label for="title"> &nbsp; &nbsp;Disable Discount Levels &nbsp;</label>   
                                            <div class="border-checkbox-section">
                                                <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                    <input class="border-checkbox" type="checkbox" name="DisableDiscountLevels" id="DisableDiscountLevels" @if($Productset->DisableDiscountLevels==1) checked="checked" @endif>
                                    ...
                                    @if($Productset->pattern)
                                    @php $patterns =  ($Productset->pattern)? json_decode($Productset->pattern) : ""; @endphp
                                    @endif

                                   <div class="form-inline">
                                    <div class="form-group">
                                            <label for="Men">Men<span class="">&nbsp;</span></label>
                                            <input type="text" @if(isset($patterns->men)) value="{{$patterns->men}}" @endif  name="pattern[men]"  class="form-control w-70 hm-30" id="men">
                                            <span>&nbsp;</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="Men">Women<span class="">&nbsp;</span></label>
                                            <input type="text"  @if(isset($patterns->women)) value="{{$patterns->women}}"  @endif name="pattern[women]" class="form-control w-70 hm-30" id="women">
                                        </div> 
                                   </div>
                                   <br>
                                   <div class="form-inline">
                                    <div class="form-group">
                                            ...
                                            <input type="text" @if(isset($patterns->kids)) value="{{$patterns->kids}}" @endif name="pattern[kids]" class="form-control w-70 hm-30" id="kids"><span class="">&nbsp;</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="Men">Unisex<span class="">&nbsp;&nbsp;&nbsp;</span></label>
                                            <input type="text" @if(isset($patterns->unisex)) value="{{$patterns->unisex}}" @endif name="pattern[unisex]" class="form-control w-70 hm-30" id="unisex">
                                        </div>  
                                   </div>
                                  <br>
                                ...
                                <div class="col-sm-12">   
                                    <div class="form-group">
                                        ...
                                        <textarea id="productset_description" type="text" rows="5" class="form-control w-40 hm-30" name="productset_description" value="" placeholder="Enter product set description" >{{$Productset->productset_description}}</textarea>
                                        <div class="help-block with-errors"></div> 
                                    </div>  
                                </div>
                                <div class="col-sm-12"> 
                                <!-- @php $set_sizes = ($Productset->size_id)?explode($Productset->size_id,','):"ssdsdsd"; @endphp -->
                             
                           @php $set_sizes = (!empty(explode(',',$Productset->size_id)))?explode(',',$Productset->size_id):"";  @endphp
                                <table class="table">
                                        <thead>
                                            <tr>
                                                <th>Sizes</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="border-checkbox-section ml-3">
                                                        <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                            <input class="border-checkbox" type="checkbox" id="inherit" value="1" name="inherit" @if($Productset->inherit_sizes==1) checked="checked" @endif>
                                        ...
                                        @if($sizeMens)
                                            @foreach($sizeMens as $menSize)
                                                ...
                                                <td>
                                                    <div class="border-checkbox-section ml-3">
                                                        <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                            <input class="border-checkbox checkItem" type="checkbox" id="{{$menSize->name}}_{{$menSize->id}}" @if(in_array($menSize->id,$set_sizes)) checked="checked" @endif value="{{$menSize->id}}" name="sizes[{{$menSize->id}}]">
                                    ...
                                    @if($sizeWomens)
                                        @foreach($sizeWomens as $womenSize)
                                            ...
                                            <td>
                                                <div class="border-checkbox-section ml-3">
                                                    <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                        <input class="border-checkbox checkItem" type="checkbox" id="{{$womenSize->name}}_{{$womenSize->id}}" @if(in_array($womenSize->id,$set_sizes)) checked="checked" @endif value="{{$womenSize->id}}" name="sizes[{{$womenSize->id}}]">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($sizeKids as $kidSize)
                                            ...
                                            <tr> 
                                                ...
                                                <div class="border-checkbox-section ml-3">
                                                    <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                        <input class="border-checkbox checkItem" type="checkbox" id="{{$kidSize->name}}_{{$kidSize->id}}" value="{{$kidSize->id}}" name="sizes[{{$kidSize->id}}]" @if(in_array($kidSize->id,$set_sizes)) checked="checked" @endif>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($sizeUnisex as $unisexSize)
                                            ...
                                            <tr> 
                                                ...
                                                <div class="border-checkbox-section ml-3">
                                                    <div class="border-checkbox-group border-checkbox-group-success d-block">
                                                        <input class="border-checkbox checkItem" type="checkbox" id="{{$unisexSize->name}}_{{$unisexSize->id}}" value="{{$unisexSize->id}}" name="sizes[{{$unisexSize->id}}]" @if(in_array($unisexSize->id,$set_sizes)) checked="checked" @endif>
