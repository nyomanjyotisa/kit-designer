		                ...
		                <table id="advanced_table" class="table">
		                    ...
		                    <tbody>
		                    	...
		                    	<tr>
		                    		...
		                    		<td>
		                    			<img src="{{ asset('img/products') }}/{{$products->id}}/{{$products->product_image}}" class="table-user-thumb" alt="">
		                    		</td>
		                    		<td>{{$products->pro_name}}</td>
		                    		<td>{{$products->pro_author}}</td>
		                    		<td>{{$products->pro_product_set}}</td>
		                    		<!-- <td>100</td>
		                    		<td>90</td>
		                    		<td>50</td>
		                    		<td>
