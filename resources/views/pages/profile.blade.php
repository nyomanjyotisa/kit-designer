                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <img src="/profile_picture/{{$user->profile_picture}}" class="rounded-circle" width="150" height="150" />
                            @else
                            <img src="https://www.its.ac.id/international/wp-content/uploads/sites/66/2020/02/blank-profile-picture-973460_1280-300x300.jpg" class="rounded-circle" width="150" height="150" />
                            @endif
            ...
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        <!-- <li class="nav-item">
                            <a class="nav-link" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true">{{ __('Timeline')}}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="false">{{ __('Setting')}}</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="/profile/update" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="example-name">{{ __('Username')}}</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="profile_picture" id="profile_picture" class="file-upload-default">
