...
class UserController extends Controller
{
    ...
    public function profileUpdate(Request $request)
    {
        ...
        $rules = array(
            ...
            'username' => ['required', Rule::unique('users')->ignore($user->id), 'alpha_dash'],
        ...
        if ($validator->fails()) {
            ...
            if(!empty($request->file('profile_picture'))){
                ...
                $profilePicture->move($path,$fileName);
                $data['profile_picture'] = $fileName;
            }
            $user->update($data);
            
            return redirect('/profile')->withSuccess('Update Profile Data Success');
        }
    }
}
